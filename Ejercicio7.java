 ...
 * una variable tipoMotor y permitir que el usuario ingrese un valor entre 1 y 4. El
 * programa debe mostrar lo siguiente:
 ...
 * pasta alimenticia”.
 * -> Si no se cumple ninguno de los valores anteriores mostrar el mensaje “No existe un
...
public class Ejercicio7 {
    public static void main(String[] args) {
        ...
        System.out.println("Escriba una opción entre 1 y 4");
